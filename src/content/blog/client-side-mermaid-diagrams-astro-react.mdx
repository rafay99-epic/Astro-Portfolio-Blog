---
title: "Client-Side Mermaid Diagrams in Astro + React: No Server Needed"
description: "How to render Mermaid.js diagrams client-side in an Astro + React app — no SSR hydration issues, no server-side rendering bugs, just clean diagrams that work on Vercel."
