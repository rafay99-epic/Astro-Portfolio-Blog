...
2\. [FormBold ](https://formbold.com/)is a great service but thye have noting for a solo website which have a couple of user, they have very similar price plan just like Formspree.

These services are good but they are way to much from cost point like 10 dollar in my country is too much and No matter what I can afford them an plus in the hobbly plan the features are that good as well. Where as Web3Form have free plan but don't work with react and astro, I have tired so much.

## The Solution

The solution for me is very simple I have use plain Astro component and inline script tage for alot of things like UI changes, status changes and sending request for web3form API as well, I know it's not the solution but I have no other choice, No matter what I do, Web3 Form only works well in the HTML and JavaScript File, in static form.

Here is the code the that I wrote for the Contact form
...
This code is very simple, I am creating a section and a form with that form there are two main things one is result id and second is the hcaptch section.

Now Using script tags in astro compoent, I have called these sccript tags when it is need, \
\\
