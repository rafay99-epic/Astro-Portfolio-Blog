...
<Tabs class="p-4 rounded-lg bg-(#7aa2f7)">
  <TabItem class="bg-(#7aa2f7)" label="Orginal Code">
...
<TabItem    class="" label="ChatGPT Code">
...
<div class="flex justify-center gap-4 p-4 bg-[#7aa2f7] rounded-lg">
  <div class="w-1/2 flex flex-col items-center">
    ...
    <img src="/BlogImages/orginal.png" alt="Original UI" class="max-w-full h-auto rounded-lg shadow-md" />
  </div>
  <div class="w-1/2 flex flex-col items-center">
    <h3 class="text-white text-lg mb-2">ChatGPT Code</h3>
    <img src="/BlogImages/ChatGPT.png" alt="ChatGPT UI" class="max-w-full h-auto rounded-lg shadow-md" />
  </div>
</div>
...
<TabItem    class="" label="DeepSeak Code">
...
<div class="flex justify-center gap-4 p-4 bg-[#7aa2f7] rounded-lg">
  ...
  <div class="w-1/2 flex flex-col items-center">
    ...
    <img src="/BlogImages/deepseak.png" alt="Deep Seak UI" class="max-w-full h-auto rounded-lg shadow-md" />
  </div>
</div>
