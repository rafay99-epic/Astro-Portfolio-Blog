...
Now the final thoughts with the intoducation to systemd and systemctl service, making service is very easy. this is just the tip of the ice bruge and you can do so much to create services that can automate your regualr stuff, Manage videos, Images, keep git record, keep snap shot of the system and much more. so be creative and code some cool scrip that that can be much better.

so Expolore the world and do share these cool services.

Untill then keep coding Nerds.
