...
pubDate: 2023-09-20 19:00:00+00:00
draft: false
heroImage: /BlogImages/bun-vs-node.webp
...
| bun add "package\_name"       | npm install "add Package name"    | Add a new package to the project                |
| bun add "package\_name" --dev | npm install "package\_name" --dev | Add a new development-only package              |
| bun remove "package\_name"    | npm uninstall "package\_name"     | Remove a package from the project               |
| bun update "package\_name"    | npm update "package\_name"        | Update a specific package to its latest version |
| bun run "script\_name"        | npm run "script\_name"            | Execute a specified script from package.json    |
