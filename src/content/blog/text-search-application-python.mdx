...
draft: false
heroImage: /Building a Powerful Text Search Application with Python and Tkinter.png
...
algorithm_choice.current(0)  # Default to brute_force

# Create checkboxes for case sensitivity and whole word matching
