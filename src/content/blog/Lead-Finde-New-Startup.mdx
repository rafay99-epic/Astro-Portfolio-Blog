...
When I start coding this project, I was using way simple one page application with react and vite, I intergrated api into a form and then idplay all the results then export the result into a simple csv file, simple but then a though hit my head I though what if I turn this into a SAS, If I was having this issue other might be as well so what could be the features so I asked chat gpt and after along dissucess we came up that is a problem and we can turn this into a real product nad this is can beb solved,

So I asked after reflecting my thoughs  I have 7 things, I need to do.

1. Get Leads
2. Export Lead into excel sheet
3. Payment Gateway (Free & Pro Tier)
4. Auth System
5. Set up a backend for managing everything
6. Simple Admin Panel for me
7. Set Limits on API

and with that racing were on.

I started coding and taking down feature after feature as well, plus I added feature flags into this so that it is easy for me to update and make sure that everything is better.

## Tech Stack

So now all the features are decided it's time for tech stack and here is thing if you are looking for somthing out of this world, it's pretty simple
...
4. Clerk
5. Convex
6. Redux UI with Shadcn as well.

when I was bulding this Project I though, the text stack would be fine at there are few things that let me think that I should have choose a framework like NextJS or something else but this current stack is doing worderfull, it's fast and I have full control and I can do alot, it's not perfect but still something are great for example build times are way faster, there is no static cotent, all dynamic content, from feature flags to blog content and from blog content to handling edge cases all these things

## Resason not going a framework
