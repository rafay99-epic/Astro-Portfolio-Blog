...
description: "We grep'd our Next.js production app, found 487 'use client'
  directives proving we were just cosplaying as full-stack, and spent three
  weeks migrating 1,076 files to React 19 + Vite just to get our dev server
  under one second and our dignity back."
