...
With all the background knowledge out we are here to talk about different AI tools that can develop full application as they claim but we are here to test and check them out.

But what the rules, Simple,

1. Free Tier Only (because I am broke)
2. Same Prompt for every single service
3. Once Chance Only, No Do over.

The reason is that most people use Free tools and all these tools are using same model under the hood, It can be claude, Auto Model or Chat GPT model.
