...
in the images bellow![Loveable promote 01](/BlogImages/loveable_promote.webp)![Loveable Promote 3](/BlogImages/loveable_promote2.webp)![Loveable Promote Processing 02](/BlogImages/loveable_promote4.webp)

As you can see that The pomoting Process is very complex and detail but it's not all rainbow and sun shine. 

In this Promote, I gave it two complex task

1. Add Auth 
2. Storge The to-do item into the DB, and for this test, Superbase was the choice. 

and this is the UI and the error 

![](/BlogImages/loveable_01.webp)![](/BlogImages/loveable_UI_4.webp)The UI is okay but no performaing the simple task is kind of a big let down so it's okay plus in order to use Auth we need to create a superbase Project and then simple conncet the project with few button which is easy to setup. 
