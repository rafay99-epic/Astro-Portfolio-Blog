...
Now we know this tool can be helpful when your are writing code and made changes to the whole code base but above I said like 90 percent it work great, it's time to talk about other 10 percent.

This is where things started to fall a part. it's not issue with the code recommandation or code reading the problem lies in commit code directly from the github, it's the core feature of the code rabbit.
