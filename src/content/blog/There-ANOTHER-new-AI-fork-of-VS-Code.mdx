...
<iframe src="https://drive.google.com/file/d/1rbbPJnbbFpJBYjDTIDV1xxepDwLoCxpy/preview" width="640" height="360" allow="autoplay" />

In the video, you can see me prompting Cascade to tell me how to run the project. It started off by suggesting `npm`. Now here’s the thing: I use **nvm (Node Version Manager)** for my Node setup, which is a shell-based install, not a system-wide one. On the other hand, **Bun** is installed system-wide.
