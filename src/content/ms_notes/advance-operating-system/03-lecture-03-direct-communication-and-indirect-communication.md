...
Think of an unnamed pipe as a temporary, direct telephone line set up exclusively between two _related_ individuals – usually a parent and a child. Once the call is over (or one hangs up), the line is gone.
