...
const DiagramButtons = memo(
  function DiagramButtons({
    ...
    const buttonClasses = useMemo(
      () => ({
        copyButton: `flex items-center gap-1 px-3 py-2 rounded-lg text-sm transition-all duration-200 backdrop-blur-sm border ${
          copied
        ...
        fullscreenButton:
          "flex items-center gap-1 px-3 py-2 rounded-lg text-sm transition-all duration-200 backdrop-blur-sm bg-[#24283b]/90 border border-[#565f89]/30 text-[#a9b1d6] hover:bg-[#414868]/50 hover:border-[#bb9af7]/50 hover:text-[#bb9af7]",
      }),
      [copied]
    );
