/* wryte:managed — "BenchmarkJump" animation generated by Wryte.
 * Edits to this file are overwritten on the next publish; edit the
 * animation inside Wryte instead. */
import { useEffect, useRef, useState } from "react";

/**
 * BenchmarkJump — same model, different harness. A bar counts up from 52.8%
 * to 66.5% (LangChain's DeepAgents jump) with nothing changed but the
 * harness, and a chip drives the point home: Vercel removed 80% of the
 * tools and got better output. Tokyo Night Dark, self-contained, drop-in.
 */
