/* wryte:managed — "SharedCodeSplit" animation generated by Wryte.
 * Edits to this file are overwritten on the next publish; edit the
 * animation inside Wryte instead. */
import { useEffect, useState } from "react";

/**
 * SharedCodeSplit — the shape that made the migration survivable.
 * 97% of 850K lines lived in one framework-agnostic core, 3% in each
 * framework shell. Cycles through the three facts that made it work.
 */
