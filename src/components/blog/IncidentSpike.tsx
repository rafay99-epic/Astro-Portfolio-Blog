/* wryte:managed — "IncidentSpike" animation generated by Wryte.
 * Edits to this file are overwritten on the next publish; edit the
 * animation inside Wryte instead. */
import { useEffect, useState } from "react";

/**
 * IncidentSpike — the Friday afternoon, minute by minute.
 * Error rate during the dashboard rollout: 0.1% accepted, 0.5% noticed,
 * 50% in minutes. Rollback landed at minute 11. Steps through the timeline.
 */
