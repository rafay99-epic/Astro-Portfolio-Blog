/* wryte:managed — "DevServerCost" animation generated by Wryte.
 * Edits to this file are overwritten on the next publish; edit the
 * animation inside Wryte instead. */
import { useEffect, useState } from "react";

/**
 * DevServerCost — what a dev server costs you to just stand there.
 * TanStack Start numbers vs Next.js numbers, from Lovable's own measurement
 * on the same codebase and the same M4 Max. Cycles which side is lit.
 * Flat by design: one hairline frame, no panels inside it.
 */
