/* wryte:managed — "CreditBurn" animation generated by Wryte.
 * Edits to this file are overwritten on the next publish; edit the
 * animation inside Wryte instead. */
import { useEffect, useState } from "react";

/**
 * CreditBurn — shows how different models drain a $20 credit pool
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 16 }}>
        {models.map((m) => {
          // For display: normalize burn so it's visually interesting
          // Haiku barely dents it, Sonnet uses a visible chunk, Opus drains fast
          const rawPool = 20;
          const used =
            m.name === "Haiku 3"
      ...
      >
        ...
        Auto mode on Cursor is unlimited and costs nothing extra. These
        burn rates only apply when you manually select a frontier model.
        The difference between Haiku and Opus is roughly{" "}
