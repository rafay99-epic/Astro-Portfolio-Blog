/* wryte:managed — "JourneySteps" animation generated by Wryte.
 * Edits to this file are overwritten on the next publish; edit the
 * animation inside Wryte instead. */
import { useEffect, useState } from "react";

/**
 * JourneySteps — the whole author-to-live journey as a self-advancing
...
export default function JourneySteps() {
  const steps = [
    ...
    { label: "Preview", detail: "Sucrase compiles it — it runs live, instantly" },
    { label: "Insert", detail: "drop <Name /> into your MDX post" },
    { label: "Publish", detail: "commit the .tsx + inject the import" },
    { label: "Live", detail: "your blog builds it and it animates for readers" },
  ];
