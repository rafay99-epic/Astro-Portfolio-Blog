/* wryte:managed — "AIStack" animation generated by Wryte.
 * Edits to this file are overwritten on the next publish; edit the
 * animation inside Wryte instead. */
import { useEffect, useRef, useState } from "react";

/**
 * AIStack — where the harness sits in the stack: framework, orchestrator,
 * harness, model. Four layers drop in with a stagger; the harness is the
 * glowing hero layer, because that's the one that actually makes the model
 * useful. Tokyo Night Dark, self-contained, drop-in.
 */
