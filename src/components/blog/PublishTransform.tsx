/* wryte:managed — "PublishTransform" animation generated by Wryte.
 * Edits to this file are overwritten on the next publish; edit the
 * animation inside Wryte instead. */
import { type ReactNode, useEffect, useState } from "react";

/**
 * PublishTransform — what publish does to your post.
 * You write a plain <Pulse />. remark-mdx parses the doc to an AST, then
 * publish splices in the import line and the client:visible directive, and
...
export default function PublishTransform() {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ fontSize: 10.5, color: c.muted, marginBottom: 8, fontFamily: mono }}>
        ...
        {line(
          <span>
            ...
            <span style={{ color: c.green }}>"../../components/blog/Pulse"</span>;
          </span>,
          shipped,
          c.text,
        )}
        {line(<span style={{ color: c.muted }}>&nbsp;</span>, shipped, c.muted)}
        <div style={{ fontFamily: mono, fontSize: 12.5, lineHeight: 1.9, color: c.muted }}>
      ...
      >
        ...
        <div style={{ fontFamily: mono, fontSize: 11.5, color: c.amber, marginTop: 4 }}>
