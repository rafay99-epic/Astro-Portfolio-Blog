/* wryte:managed — "GuardrailAsymmetry" animation generated by Wryte.
...
export default function GuardrailAsymmetry() {
  ...
  const current =
    side === 0 ? attacker : side === 1 ? defender : solution;
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <div
            style={{
              ...
              borderRadius: 10,
              background: current.label.includes("Defender") ? `${current.barrierColor}10` : c.panel,
              padding: "12px 10px",
              textAlign: "center",
              transition: "all .4s ease",
              boxShadow: current.label.includes("Defender") ? `0 0 20px -6px ${current.barrierColor}` : "none",
            }}
          >
            <div
              style={{
            ...
            >
              {side === 1 ? "BLOCKED by safety classifiers" : "Unrestricted access"}
            </div>
            <div
              style={{
                marginTop: 10,
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          >
            ...
            >
              {side === 0 ? "Open-weight / jailbroken model" : "Attacker (uncensored)"}
            </div>
            <div
              style={{
                padding: "4px 8px",
      ...
      >
        ...
        Safety guardrails block defenders from analyzing attacks,
        while attackers face no such limits.
      </div>
    </div>
  );
}
