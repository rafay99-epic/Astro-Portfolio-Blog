/* wryte:managed — "HarnessLoop" animation generated by Wryte.
 * Edits to this file are overwritten on the next publish; edit the
 * animation inside Wryte instead. */
import { useEffect, useRef, useState } from "react";

/**
 * HarnessLoop — the runtime that runs on every prompt, as a hub-and-spoke.
 * YOU, MODEL and TOOLS orbit the HARNESS hub; a packet travels the active
 * spoke while a caption narrates the nine stages of one turn. The model
 * never touches the outside world — every edge routes through the hub.
 * Tokyo Night Dark, self-contained, drop-in.
 */
