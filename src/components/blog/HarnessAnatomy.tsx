/* wryte:managed — "HarnessAnatomy" animation generated by Wryte.
 * Edits to this file are overwritten on the next publish; edit the
 * animation inside Wryte instead. */
import { useEffect, useRef, useState } from "react";

/**
 * HarnessAnatomy — the five layers of a harness, stacked.
 * A blueprint-style column: you on top, the harness (the star zone) in the
 * middle with its five parts sweeping in one by one, the model near the
 * bottom, and the outside world underneath. A pulse falls down the spine to
 * show the flow. Tokyo Night Dark, self-contained, drop-in.
 */
