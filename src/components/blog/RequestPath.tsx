/* wryte:managed — "RequestPath" animation generated by Wryte.
...
export default function RequestPath() {
  ...
  const billed = active > 0 && nodes[active].hot ? 1 : 0;
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
              <div
                style={{
                  ...
                  borderRadius: "50%",
                  background:
                    i === active ? (n.hot ? c.red : i === 0 ? c.blue : c.green) : c.line,
                  boxShadow:
                    i === active ? `0 0 12px -2px ${n.hot ? c.red : c.green}` : "none",
