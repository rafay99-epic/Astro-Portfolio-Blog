...
// }) => {
//   return (
//     <div className="bg-[#1f2335] text-[#F8F8F8] py-8">
...
//               >
//                 <article className="bg-[#1f2335] border border-[#7aa2f7] rounded-lg overflow-hidden hover:scale-105 hover:shadow-2xl transition-all duration-300 flex flex-col h-full">
//                   <img
...
//                     <h2 className="text-2xl font-bold mb-2 text-[#7aa2f7]">
//                       {post.data.title}
//                     </h2>
//                     <p className="text-[#F8F8F8] opacity-75 mb-2 text-sm">
//                       {new Date(post.data.pubDate).toLocaleDateString()}
//                     </p>
//                     <p className="text-[#F8F8F8] line-clamp-3">
...
//             <p className="text-2xl font-bold text-[#7aa2f7] mb-4">
//               Sorry, No Featured Blog Posts
//             </p>
//             <p className="text-lg text-[#F8F8F8] opacity-75">
